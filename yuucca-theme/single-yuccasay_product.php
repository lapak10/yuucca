...
$is_added_to_cart=true;
	...
	//ok, the request is to add the product into the cart...lets do it!
      $_SESSION['anand_store'][$str]=array(
...
<button type="submit" value='add_this_to_cart' <?php echo $is_added_to_cart?'disabled':''; ?> name="submit" class="btn btn-primary"><?php echo $is_added_to_cart?'already added':'add to cart'; ?></button>
