...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_register_script('angular-core', '//ajax.googleapis.com/ajax/libs/angularjs/1.5.0/angular.js', ['jquery'], null, true);
    wp_register_script('angular-route', '//ajax.googleapis.com/ajax/libs/angularjs/1.5.0/angular-route.min.js', ['angular-core'], null, true);
  //wp_register_script('angular-app', get_bloginfo('template_directory').'/app.js', array('angular-core'), null, false);
    ...
    wp_register_script('anand_angular_app', (get_template_directory_uri().'/angular_app/anand_app.js'), ['angular-core'], null, true);
  // enqueue all scripts
