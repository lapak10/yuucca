...
class yucca_shopAdminPageFramework_Property_page_meta_box extends yucca_shopAdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'yucca-shop', $sStructureType = 'page_meta_box') {
        ...
        $GLOBALS['ayucca_shopAdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('ayucca_shopAdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('ayucca_shopAdminPageFramework', 'aPageClasses'));
