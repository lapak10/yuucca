...
abstract class yucca_shopAdminPageFramework_MetaBox_Router extends yucca_shopAdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'yucca-shop') {
