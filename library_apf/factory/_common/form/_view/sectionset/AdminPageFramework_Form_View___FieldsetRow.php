...
class yucca_shopAdminPageFramework_Form_View___FieldsetTableRow extends yucca_shopAdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new yucca_shopAdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'yucca-shop-fieldrow',));
        return $this->_getFieldByContainer($aFieldset, array('open_container' => "<tr " . $_oFieldrowAttribute->get() . ">", 'close_container' => "</tr>", 'open_title' => "<th>", 'close_title' => "</th>", 'open_main' => "<td " . $this->getAttributes(array('colspan' => $aFieldset['show_title_column'] ? 1 : 2, 'class' => $aFieldset['show_title_column'] ? null : 'yucca-shop-field-td-no-title',)) . ">", 'close_main' => "</td>",));
    }
