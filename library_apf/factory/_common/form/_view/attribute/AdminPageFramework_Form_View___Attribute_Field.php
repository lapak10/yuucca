...
class yucca_shopAdminPageFramework_Form_View___Attribute_Field extends yucca_shopAdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "yucca-shop-field yucca-shop-field-" . $this->aArguments['type'] . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' yucca-shop-subfield', ''));
    }
}
