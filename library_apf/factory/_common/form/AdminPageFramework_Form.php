...
class yucca_shopAdminPageFramework_Form_View extends yucca_shopAdminPageFramework_Form_Model {
    ...
    public function get() {
        ...
        $_oFormTables = new yucca_shopAdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->getFieldErrors(), $this->aCallbacks, $this->oMsg);
