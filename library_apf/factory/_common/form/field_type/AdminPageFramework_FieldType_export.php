...
class yucca_shopAdminPageFramework_FieldType_submit extends yucca_shopAdminPageFramework_FieldType {
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'yucca-shop-input-label-container' . ' yucca-shop-input-button-container' . ' yucca-shop-input-container',);
    }
