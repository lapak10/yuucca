...
class yucca_shopAdminPageFramework_View__PageRenderer extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render()
    {
        ...
        ?>
            <div class="yucca-shop-container">    
                <?php
    ...
    {
        $_oScreenIcon = new yucca_shopAdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new yucca_shopAdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop .= $_oPageHeadingTabs->get();
        $_oInPageTabs = new yucca_shopAdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug)
    {
        ...
        echo "<div class='yucca-shop-content'>";
    ...
    {
        $_oPageMetaBoxRenderer = new yucca_shopAdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true)
    {
        ...
        echo '<form '.$this->getAttributes(['method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'yucca-shop-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage))]).' >'.PHP_EOL;
