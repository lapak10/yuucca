...
class yucca_shopAdminPageFramework_HelpPane_admin_page extends yucca_shopAdminPageFramework_HelpPane_Base
{
    protected static $_aStructure_HelpTabUserArray = ['page_slug' => null, 'page_tab_slug' => null, 'help_tab_title' => null, 'help_tab_id' => null, 'help_tab_content' => null, 'help_tab_sidebar_content' => null];
    ...
    public function __construct($oProp)
    {
        ...
        add_action('admin_head', [$this, '_replyToRegisterHelpTabs'], 200);
    }
    ...
    public function _addHelpTab($aHelpTab)
    {
        ...
        if (!isset($this->oProp->aHelpTabs[$aHelpTab['help_tab_id']])) {
            $this->oProp->aHelpTabs[$aHelpTab['help_tab_id']] = ['sID' => $aHelpTab['help_tab_id'], 'sTitle' => $aHelpTab['help_tab_title'], 'aContent' => !empty($aHelpTab['help_tab_content']) ? [$this->_formatHelpDescription($aHelpTab['help_tab_content'])] : [], 'aSidebar' => !empty($aHelpTab['help_tab_sidebar_content']) ? [$this->_formatHelpDescription($aHelpTab['help_tab_sidebar_content'])] : [], 'sPageSlug' => $aHelpTab['page_slug'], 'sPageTabSlug' => $aHelpTab['page_tab_slug']];
