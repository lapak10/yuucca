...
class yucca_shopAdminPageFramework_Model__FormSubmission__Validator extends yucca_shopAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Link', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Import', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Export', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Reset', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
