...
class yucca_shopAdminPageFramework_Model__FormSubmission__Validator_Base extends yucca_shopAdminPageFramework_Model__FormSubmission_Base
{
    public $oFactory;
    ...
    public function __construct($oFactory)
    {
        ...
        $_sFunctionName($this->sActionHookPrefix.$this->oFactory->oProp->sClassName, [$this, $this->sCallbackName], $this->iHookPriority, $this->iCallbackParameters);
    }
...
class yucca_shopAdminPageFramework_Model__FormSubmission__Validator extends yucca_shopAdminPageFramework_Model__FormSubmission__Validator_Base
{
    public $oFactory;
    public $aInputs = [];
    public $aRawInputs = [];
    ...
    {
        $this->oFactory = $oFactory;
        add_filter('validation_pre_'.$this->oFactory->oProp->sClassName, [$this, '_replyToValiateUserFormInputs'], 10, 4);
    }
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory)
    {
        ...
        $_aSubmitsInformation = ['page_slug' => $_sPageSlug, 'tab_slug' => $_sTabSlug, 'input_id' => $this->_getPressedSubmitButtonData($_aSubmits, 'input_id'), 'section_id' => $_sSubmitSectionID, 'field_id' => $this->_getPressedSubmitButtonData($_aSubmits, 'field_id'), 'input_name' => $_sPressedInputName];
        $_aClassNames = ['yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Link', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Import', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Export', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Reset', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'yucca_shopAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm'];
        ...
        try {
            ...
            $_oFormSubmissionFilter = new yucca_shopAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
