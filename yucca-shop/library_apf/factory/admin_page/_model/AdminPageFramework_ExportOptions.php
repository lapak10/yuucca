...
abstract class yucca_shopAdminPageFramework_CustomSubmitFields extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public $aPost = [];
    public $sInputID;
    ...
    {
        return $this->getElement($aElement, [$sInputID, $sElementKey], null);
    }
...
class yucca_shopAdminPageFramework_ExportOptions extends yucca_shopAdminPageFramework_CustomSubmitFields
{
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    ...
    public function doExport($vData, $sFormatType = null, array $aHeader = [])
    {
    ...
    private function _outputDataByType($vData, $sFormatType)
    {
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), ['array', 'object'])) {
                    echo yucca_shopAdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
