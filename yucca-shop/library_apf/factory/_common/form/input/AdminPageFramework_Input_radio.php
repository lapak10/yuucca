...
class yucca_shopAdminPageFramework_Input_radio extends yucca_shopAdminPageFramework_Input_Base
{
    public function get()
    {
    ...
    public function getAttributesByKey()
    {
        ...
        return $this->getElementAsArray($this->aAttributes, $_sKey, []) + ['type' => 'radio', 'checked' => isset($this->aAttributes['value']) && $this->aAttributes['value'] == $_sKey ? 'checked' : null, 'value' => $_sKey, 'id' => $this->getAttribute('id').'_'.$_sKey, 'data-id' => $this->getAttribute('id')] + $this->aAttributes;
    }
}
