...
class yucca_shopAdminPageFramework_Form___FieldError extends yucca_shopAdminPageFramework_FrameworkUtility
{
    ...
    public function set($aErrors)
    {
        if (empty(self::$_aErrors)) {
            add_action('shutdown', [$this, '_replyToSave']);
        }
    ...
    public function get()
    {
        ...
        return $this->getElementAsArray(self::$_aFieldErrorCaches[$this->sTransientKey], $this->sCallerID, []);
    }

    private static $_aFieldErrorCaches = [];
    ...
    public function delete()
    {
        ...
        add_action('shutdown', [$this, '_replyToDelete']);
    }
