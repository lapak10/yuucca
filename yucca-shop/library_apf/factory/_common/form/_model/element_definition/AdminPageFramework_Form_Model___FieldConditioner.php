...
class yucca_shopAdminPageFramework_Form_Model___SectionConditioner extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public $aSectionsets = [];

    public function __construct()
    {
        $_aParameters = func_get_args() + [$this->aSectionsets];
    ...
    private function _getSectionsConditioned(array $aSections = [])
    {
        $_aNewSections = [];
...
class yucca_shopAdminPageFramework_Form_Model___FieldConditioner extends yucca_shopAdminPageFramework_Form_Model___SectionConditioner
{
    public $aSectionsets = [];
    public $aFieldsets = [];
    ...
    public function __construct()
    {
        $_aParameters = func_get_args() + [$this->aSectionsets, $this->aFieldsets];
        $this->aSectionsets = $_aParameters[0];
