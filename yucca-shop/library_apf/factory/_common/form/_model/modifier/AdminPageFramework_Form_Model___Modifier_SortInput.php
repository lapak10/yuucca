...
class yucca_shopAdminPageFramework_Form_Model___Modifier_SortInput extends yucca_shopAdminPageFramework_Form_Model___Modifier_Base
{
    public $aInput = [];
    public $aFieldAddresses = [];

    public function __construct()
    {
        $_aParameters = func_get_args() + [$this->aInput, $this->aFieldAddresses];
