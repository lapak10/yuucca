...
class yucca_shopAdminPageFramework_Form_Model___LastInput extends yucca_shopAdminPageFramework_FrameworkUtility
{
    private static $_aLastInputs = [];
    public $sCallerID;
    ...
    public function get()
    {
        ...
        return $this->getElementAsArray($_aLastInputs, $this->sCallerID, []);
    }

    private static $_aCaches = [];
