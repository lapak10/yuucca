...
class yucca_shopAdminPageFramework_Form_Model___Format_Fieldset extends yucca_shopAdminPageFramework_Form_Model___Format_FormField_Base
{
    ...
    {
        $_aParameters = func_get_args() + [$this->aFieldset, $this->sStructureType, $this->sCapability, $this->iCountOfElements, $this->iSubSectionIndex, $this->bIsSectionRepeatable, $this->oCallerObject];
    ...
    public function get()
    {
        $_aFieldset = $this->uniteArrays(['_fields_type' => $this->sStructureType, '_structure_type' => $this->sStructureType, '_caller_object' => $this->oCallerObject, '_subsection_index' => $this->iSubSectionIndex] + $this->aFieldset, ['capability' => $this->sCapability, 'section_id' => '_default', '_section_repeatable' => $this->bIsSectionRepeatable] + self::$aStructure);
...
class yucca_shopAdminPageFramework_Form_Model___Format_FieldsetOutput extends yucca_shopAdminPageFramework_Form_Model___Format_Fieldset
{
    public static $aStructure = ['_section_index' => null, 'tag_id' => null, '_tag_id_model' => '', '_field_name' => '', '_field_name_model' => '', '_field_name_flat' => '', '_field_name_flat_model' => '', '_field_address' => '', '_field_address_model' => '', '_parent_field_object' => null];
    public $aFieldset = [];
    ...
    public function __construct()
    {
        $_aParameters = func_get_args() + [$this->aFieldset, $this->iSectionIndex, $this->aFieldTypeDefinitions];
        $this->aFieldset = $_aParameters[0];
    ...
    public function get()
    {
        ...
        $_oFieldTagIDGenerator = new yucca_shopAdminPageFramework_Form_View___Generate_FieldTagID($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfTagID']);
        $_aFieldset['tag_id'] = $_oFieldTagIDGenerator->get();
        $_aFieldset['_tag_id_model'] = $_oFieldTagIDGenerator->getModel();
        $_oFieldNameGenerator = new yucca_shopAdminPageFramework_Form_View___Generate_FieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfName']);
        $_aFieldset['_field_name'] = $_oFieldNameGenerator->get();
        $_aFieldset['_field_name_model'] = $_oFieldNameGenerator->getModel();
        $_oFieldFlatNameGenerator = new yucca_shopAdminPageFramework_Form_View___Generate_FlatFieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfNameFlat']);
        ...
        $_oFieldAddressGenerator = new yucca_shopAdminPageFramework_Form_View___Generate_FieldAddress($_aFieldset);
    ...
    {
        return $this->uniteArrays($aFieldset, $this->getElementAsArray($aFieldTypeDefinitions, [$aFieldset['type'], 'aDefaultKeys'], []));
    }
}
