...
class yucca_shopAdminPageFramework_Form_Model___Format_EachSection extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public static $aStructure = ['_count_subsections' => 0, '_is_first_index' => false, '_is_last_index' => false, '_index' => null, '_is_collapsible' => false, '_tag_id' => '', '_tag_id_model' => '', '_sections_id' => ''];
    public $aSection = [];
    public $iIndex = null;
    public $aSubSections = [];
    public $sSectionsID = '';
    ...
    {
        $_aParameters = func_get_args() + [$this->aSection, $this->iIndex, $this->aSubSections, $this->sSectionsID];
