...
abstract class yucca_shopAdminPageFramework_Form_View___Generate_Section_Base extends yucca_shopAdminPageFramework_Form_View___Generate_Base
{
    ...
    {
        $_aParameters = func_get_args() + [$this->aArguments, $this->hfCallback];
    ...
    {
        return is_callable($this->hfCallback) ? call_user_func_array($this->hfCallback, [$sSubject, $this->aArguments]) : $sSubject;
    }
...
class yucca_shopAdminPageFramework_Form_View___Generate_SectionName extends yucca_shopAdminPageFramework_Form_View___Generate_Section_Base
{
    public function get()
    {
    ...
    {
        $this->aArguments = $this->aArguments + ['section_id' => null, '_index' => null];
        if (isset($isIndex)) {
