...
class yucca_shopAdminPageFramework_Form_View___Fieldset___FieldError extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public $aErrors = [];
    public $aSectionPath = [];
    public $aFieldPath = [];
    ...
    {
        $_aParameters = func_get_args() + [$this->aErrors, $this->aSectionPath, $this->aFieldPath, $this->sHeadingMessage];
