...
class yucca_shopAdminPageFramework_Form_Meta extends yucca_shopAdminPageFramework_Form
{
    public function updateMetaDataByType($iObjectID, array $aInput, array $aSavedMeta, $sStructureType = 'post_meta_box')
    {
        ...
        $_aFunctionNameMapByFieldsType = ['post_meta_box' => 'update_post_meta', 'user_meta' => 'update_user_meta'];
