...
class yucca_shopAdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'yucca-shop') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof yucca_shopAdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new yucca_shopAdminPageFramework_Message($sTextDomain);
