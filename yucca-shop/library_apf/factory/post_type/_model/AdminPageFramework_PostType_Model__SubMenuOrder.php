...
class yucca_shopAdminPageFramework_PostType_Model__SubMenuOrder extends yucca_shopAdminPageFramework_FrameworkUtility
{
    public $oFactory;
    ...
    public function __construct($oFactory)
    {
        ...
        add_action('admin_menu', [$this, '_replyToSetSubMenuOrder'], 200);
        add_action('admin_menu', [$this, 'sortAdminSubMenu'], 9999);
    }
    ...
    private function _getPostTypeMenuLinkSlugs()
    {
        ...
        $_aLinkSlugs = [$_sLinkSlugManage => $_nSubMenuOrderManage, 'post-new.php?post_type='.$this->oFactory->oProp->sPostType => $_nSubMenuOrderAddNew];
    ...
    {
        foreach ($this->getElementAsArray($GLOBALS, ['submenu', $sSubMenuSlug]) as $_nIndex => $_aSubMenuItem) {
    ...
    private function _setSubMenuIndexByLinksSlug($sSubMenuSlug, $nIndex, $aSubMenuItem, $sLinkSlug, $nOrder)
    {
        ...
        $_nNewIndex = $this->getUnusedNumericIndex($this->getElementAsArray($GLOBALS, ['submenu', $sSubMenuSlug]), $nOrder);
