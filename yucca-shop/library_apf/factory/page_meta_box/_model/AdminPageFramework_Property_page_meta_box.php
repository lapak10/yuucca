...
class yucca_shopAdminPageFramework_Property_page_meta_box extends yucca_shopAdminPageFramework_Property_post_meta_box
{
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'yucca-shop', $sStructureType = 'page_meta_box')
    {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['ayucca_shopAdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, ['ayucca_shopAdminPageFramework', 'aMetaBoxForPagesClasses']);
        $GLOBALS['ayucca_shopAdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, ['ayucca_shopAdminPageFramework', 'aPageClasses']);
